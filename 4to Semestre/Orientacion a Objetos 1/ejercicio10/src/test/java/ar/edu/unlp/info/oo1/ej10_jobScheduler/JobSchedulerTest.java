...
public class JobSchedulerTest {
    ...
    private JobScheduler newFifoScheduler() {
        JobScheduler fifoScheduler = new SchedulerFifo();
        return fifoScheduler;
    }

    private JobScheduler newLifoScheduler() {
        JobScheduler lifoScheduler = new SchedulerLifo();
        return lifoScheduler;
    }

    private JobScheduler newPriorityScheduler() {
        JobScheduler priorityScheduler = new SchedulerHP();
        return priorityScheduler;
    }

    private JobScheduler newEffortScheduler() {
        JobScheduler effortScheduler = new SchedulerME();
    ...
    @Test
    void testSchedule() {
        JobScheduler aScheduler = new SchedulerFifo();
    ...
    @Test
    void testUnschedule() {
        JobScheduler aScheduler = new SchedulerHP();
